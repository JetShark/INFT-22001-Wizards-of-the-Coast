      ...
      <Wrapper id="latest">
        ...
        <div className="whiteBg" style={{ padding: "60px 0" }}>
          <div className="container">
            ...
            <ProductsBoxWrapper>
              <ProductsBox
                icon="roller" // icons ( needs to be changed)
            ...
            <ProductsBoxWrapper>
              <ProductsBox icon="printer" title="Commander Masters" subtitle="Commander Masters is the first Masters set made for Magic’s most popular format. Upgrade your favorite decks or build something new with all the power and collectability players expect from the Masters name." />
            </ProductsBoxWrapper>
          </ProductsBoxRow>
          </div>
        </div>
      ...
      <Wrapper id="special">
        <div className="container">
          ...
          <ProductsBoxRow className="flex">
            ...
            <ProductsBoxWrapper>
              <ProductsBox icon="printer" title="PHYREXIA: ALL WILL BE ONE" subtitle="Each Set Booster contains 12 Magic cards, 1 Art Card, and 1 token/ad card or card from “The List” (a list of special cards from Magic’s history and mechanically identical versions of cards originally printed in Secret Lair x Street Fighter featuring Magic-themed art—1 in 25% of packs)." />
            </ProductsBoxWrapper>
          </ProductsBoxRow>
        </div>
      </Wrapper>
